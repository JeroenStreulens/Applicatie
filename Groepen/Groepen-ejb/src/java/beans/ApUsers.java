...
@NamedQueries({
    ...
    , @NamedQuery(name = "ApUsers.findBySuaam", query = "SELECT a FROM ApUsers a WHERE a.suaam = :suaam")
...
public class ApUsers implements Serializable {
    ...
    public ApUsers(Integer unr, String suaam, String upwoord) {
        this.unr = unr;
        this.suaam = suaam;
    ...
    public String getSuaam() {
        return suaam;
    }

    public void setSuaam(String suaam) {
        this.suaam = suaam;
    }
